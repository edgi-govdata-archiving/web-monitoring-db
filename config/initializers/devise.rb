require_dependency 'jwt_tools/jwt_auth_strategy'
require_dependency 'jwt_tools/jwt_coder'
...
Devise.setup do |config|
  ...
  # config.secret_key = '528f825172225475ed0fb030eafd5e921fee004ce5bab0b89fb4a2887b19e32e26f90b3fb978e5b278b39a0f9a3e0dae894ccc9a65a29b6e525a6ce473f58083'

  # ==> Mailer Configuration
  # Configure the e-mail address which will be shown in Devise::Mailer,
  # note that it will be overwritten if you use your own mailer class
  # with default "from" parameter.
  config.mailer_sender = ENV.fetch('MAIL_SENDER', 'web-monitoring-db@envirodatagov.org')
  ...
  # config.pepper = 'ad306bea28a9a9e469ec8bb906a0f927cf5aeb09df0da65d67625420fcebccb11c0cbda8ddd3acdd4b34f85460ea6393bc1b82ae5c0c654cc525873fd89286a6'
  ...
  config.warden do |manager|
    ...
    manager.strategies.add(:jwt, JwtTools::JwtAuthStrategy)
...
JwtTools::JwtCoder.private_key = raw_private_key
